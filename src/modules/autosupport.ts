...
export default class AutoSupportModule extends Module {
  ...
  constructor(conf: any, data: any, guilds: Map<string, any>, lang: (string) => string) {
    super('Auto Support', 'ℹ️', 'Takes work off your support team', 'This module is currently disabled while we are working on version 2', 'public', conf, data, guilds, lang)
  }
