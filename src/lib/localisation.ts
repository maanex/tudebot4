...
export type DefaultLocale = 'en-US' | 'de'

export type LocaleContainer = DefaultLocale | GenericInteraction

export default class Localisation {

  private static readonly DEFAULT_LANGUAGE_ID: DefaultLocale = 'en-US'

  private static list: Set<string> = new Set()
  private static idmap: Map<number, string> = new Map()
  private static texts: Map<string, Record<string, string | string[]>> = new Map()
  ...
  public static load(languages: Record<string, any>[]) {
    ...
    for (const lang of all) {
      ...
      Localisation.texts.set(lang._id, lang as Record<string, string | string[]>)
    }
  }
  ...
  public static getLocaleFromContainer(cont: LocaleContainer): string {
    ...
    if (typeof cont === 'string')
      return Localisation.findClosestLanguageMatch(cont)
